...
void VWB_DrawPicScaledCoord (int scx, int scy, int chunknum)
{
    ...
    VL_MemToScreenScaledCoord (grsegs[chunknum],width,height,scx,scy, NULL, NULL, NULL, NULL);
}
...
{
    VL_LatchToScreen(latchpics[2 + picnum - LATCHPICS_LUMP_START], x * 8, y, NULL, NULL, NULL, NULL);
}
